                ...
                <div className="grid gap-10 lg:grid-cols-[0.95fr_0.8fr] lg:items-center">
                    <div className="space-y-8">
                        <div className="space-y-3">
                            <p className="text-sm uppercase tracking-[0.32em] text-brand-300">Uday Profile</p>
                            <h1 className="text-4xl font-semibold tracking-tight text-white">Uday HR</h1>
                        ...
                        <blockquote className="rounded-[1.5rem] border border-white/10 bg-white/5 p-8 text-xl leading-9 text-slate-100 shadow-lg">
                            “No matter what happens, I’ll always appreciate the way you’ve been there for me.”
                        </blockquote>

                        <div className="flex flex-wrap gap-3 text-sm">
                            <span className="rounded-full bg-brand-300 px-4 py-2 font-semibold text-slate-950">Name: Uday HR</span>
